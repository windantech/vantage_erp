...
?>
                                        ...
                                        <div class="col-xl-12 col-md-12 p-1">
                                            <div class="input-group mb-3 position-relative">
                                                ...
                                                <input type="text" name="email_subject" id="email_subject" class="form-control rounded-0 w-100" placeholder="Enter Subject" aria-label="Subject" aria-describedby="basic-addon1" required onkeyup="document.getElementById('subject_email').innerHTML = '<b>' + this.value + '</b>';">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12 col-md-12 p-1">
                                            <div class="input-group px-1 mb-3 position-relative">
                                                ...
                                                <textarea name="email_body" id="summernote5" class="form-control" required></textarea>
                                            </div>
                                        </div>
