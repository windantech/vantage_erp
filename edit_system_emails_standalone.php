            ...
            <form class="row" id="upd_step1">
                ...
                <div class="col-md-6 p-1 <?php echo $saved_email_type=='virtual'?'d-none':''; ?>" id="upd_event_container">
                    <div class="input-group mb-3">
                        ...
                        <select id="upd_event_opt" class="form-control rounded-0">
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res && res.ok && res.html) {
                    $("#upd_status").css("color", "#1a7a3c").text("Built into the house template — design & footer intact. Edit on the left.");
                    place(res.html);
                } else {
