...
<section id="content-wrapper" class="d-flex flex-column">
  <div id="content">
    ...
    .bde-app tr.me td{background:linear-gradient(90deg,color-mix(in srgb,#3a7bd5 22%,var(--surface)),color-mix(in srgb,#3a7bd5 9%,var(--surface)) 42%,transparent 80%)} .bde-app tr.me .a{background:linear-gradient(150deg,#3a7bd5,#2a5aa8)}
