...
<section id="content-wrapper" class="d-flex flex-column">
  <div id="content">
    ...
    .bde-app .steps3{display:grid;grid-template-columns:repeat(3,1fr);gap:12px} .bde-app .stepbox{position:relative;overflow:hidden;background:var(--surface2);border:1px solid var(--line);border-radius:var(--radius-sm);padding:14px 15px} .bde-app .stepbox::before{content:"";position:absolute;left:0;top:0;bottom:0;width:3px;background:var(--sacc,var(--line))} .bde-app .stepbox .stop{display:flex;align-items:center;gap:9px;margin-bottom:9px} .bde-app .stepbox .sbadge2{width:26px;height:26px;border-radius:50%;display:grid;place-items:center;font-size:12px;font-weight:900;flex:none} .bde-app .stepbox .sbadge2 svg{width:13px;height:13px} .bde-app .stepbox span{font-size:9.5px;text-transform:uppercase;letter-spacing:.08em;color:var(--muted);font-weight:800} .bde-app .stepbox b{display:block;font-size:15px;margin:0 0 4px} .bde-app .stepbox .st{font-size:11.5px;font-weight:700}
    .bde-app .stepbox.done{--sacc:var(--jade)} .bde-app .stepbox.done .sbadge2{background:var(--jade);color:#fff} .bde-app .stepbox.current{--sacc:var(--amber);box-shadow:0 0 0 2px color-mix(in srgb,var(--amber) 40%,transparent)} .bde-app .stepbox.current .sbadge2{background:var(--amber);color:#fff} .bde-app .stepbox.future{--sacc:var(--line)} .bde-app .stepbox.future .sbadge2{background:var(--surface3);color:var(--faint)}
      ...
      function vCommission(){
        ...
        return `
          ...
          <div class="card"><div class="chead"><h4>Three-month consistency journey</h4><span class="chip slate">Month 2 of 3</span></div>
            <div class="steps3"><div class="stepbox done"><div class="stop"><span class="sbadge2">✓</span><span>Month 1</span></div><b>Target achieved</b><div class="st" style="color:var(--jade)">Verified</div></div><div class="stepbox current"><div class="stop"><span class="sbadge2">●</span><span>Month 2</span></div><b>${att>=1?"On track":"Recovery required"}</b><div class="st" style="color:${att>=1?"var(--jade)":"var(--amber)"}">${pct(att)} current attainment</div></div><div class="stepbox future"><div class="stop"><span class="sbadge2"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="11" width="14" height="9" rx="2"/><path d="M8 11V8a4 4 0 0 1 8 0v3"/></svg></span><span>Month 3</span></div><b>Future period</b><div class="st" style="color:var(--muted)">Consistency reward pending</div></div></div>
          </div>`;
      }
