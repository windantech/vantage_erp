                ...
                <div class="card-header bg_main rounded-0 py-3">
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="w-50 d-flex justify-content-end align-items-center">
                            <button onclick="location.href='system_emails'" class="btn border-0 p-0 ms-3">
                                    ...
                                    <form id="update_email_form">
                                        ...
                                        <div class="col-xl-12 col-md-12 p-1">
                                            <div class="input-group mb-3 position-relative">
                                                ...
                                                <input type="text" name="email_title" id="email_title" class="form-control rounded-0 w-100" value="<?php echo $sm__data['title']; ?>" placeholder="Enter Title" aria-label="Title" aria-describedby="basic-addon1" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12 col-md-12 p-1">
                                            <div class="input-group mb-3 position-relative">
                                                ...
                                                <input type="text" name="email_subject" id="email_subject" class="form-control rounded-0 w-100" value="<?php echo $sm__data['subject']; ?>" placeholder="Enter Subject" aria-label="Subject" aria-describedby="basic-addon1" required onkeyup="document.getElementById('subject_email').innerHTML = '<b>' + this.value + '</b>';">
                                            </div>
                                        </div>

                                        <div class="col-xl-12 col-md-12 p-1">
                                            <div class="input-group px-1 mb-3 position-relative">
                                                <span class="input-group-text rounded-0 bg_main" style="width: 9rem;" id="basic-addon1">Body</span>
                                                <textarea name="email_body" id="summernote5" class="form-control" required><?php echo $sm__data['body']; ?></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div style="border: solid 1px #d1d3e2;">
                                        ...
                                        <div style="padding: 0 .5rem">
                                            <h5 id="subject_email">
                                                <b><?php echo $sm__data['subject']; ?></b>
                                            </h5>
                                            <p>
                                                Dear,
                                            </p>
                                            <div id="body_email">
                                                <?php echo $sm__data['body']; ?>
                                            </div>
                                        </div>
