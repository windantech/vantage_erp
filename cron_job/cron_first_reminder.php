...
$course_name="Online Performance Management Course";
$course_intro="With this training, you'll learn how to set clear performance expectations, provide feedback, and motivate your team to achieve their goals, enabling you to build a high-performing team and achieve organizational success.";
$name="";
$intro_link="https://youtu.be/bBgm0OIKL9I";
$app_id ="353759";
$subject="Dont Miss Out on Our ".$course_name."!";
                ...
                <td class="wrapper" style="font-family: Century Gothic; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;" valign="top">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    <tr>
                      ...
                      I hope this email finds you well. I noticed that you registered for our '.$course_name.', but have not yet completed your payment.
<br><br>'.$course_intro.'
<br><br>
...
<br><br>
Kindly click the link below view course outline   <a href="'.$intro_link.'">View course outline </a><br>
Click the link below to make  payment  <a href="https://system.vantageafricaleaders.com/pay/index.php?id='.$app_id.'">Make payment</a><br><br>
